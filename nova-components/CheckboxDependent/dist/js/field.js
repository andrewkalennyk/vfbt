...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-checkbox-dependent', __webpack_require__(3));
    Vue.component('detail-checkbox-dependent', __webpack_require__(6));
    Vue.component('form-checkbox-dependent', __webpack_require__(9));
});
    ...
    computed: {
        watchedComponents: function watchedComponents() {
            ...
            return this.$parent.$children.filter(function (component) {
                return _this3.isWatchingComponent(component);
            });
        },
