...
Nova.booting(function (Vue, router, store) {
    Vue.component('input-filter', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        handleChange: function handleChange(event) {
            var inputValue = escape(event.target.value);
...
var render = function() {
  ...
  return _c("div", [
    ...
    _c("div", { staticClass: "p-2" }, [
      _c("input", {
        staticClass: "block w-full rounded border border-60 form-control-sm",
        attrs: { type: "text", dusk: _vm.filter.name + "-filter-select" },
